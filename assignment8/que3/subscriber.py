...
def on_connect(client, userdata, flags, rc, properties=None):
    ...
    client.subscribe("Abhijeet/sensor/temperature")
    client.subscribe("Abhijeet/sensor/humidity")
...
def on_message(client, userdata, msg):
    ...
    if msg.topic == "Abhijeet/sensor/temperature":
        print(f"Temperature: {value} °C")
        if value > TEMP_THRESHOLD:
            print("⚠ ALERT: High Temperature")

    elif msg.topic == "Abhijeet/sensor/humidity":
